...
class _WeatherForecastState extends State<WeatherForecast> {
  ...
  Widget build(BuildContext context) {
    return Consumer2<WeatherForecastService, SettingsService>(
        builder: (context, weatherForecastService, settingsService, child) {
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                Text(
                  '${currentItem.tempratureMax}°${settingsService.value.unit == 'metric' ? 'C' : 'F'}',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                  ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Text(
                  '${currentItem.tempratureMin}°${settingsService.value.unit == 'metric' ? 'C' : 'F'}',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                  ),
